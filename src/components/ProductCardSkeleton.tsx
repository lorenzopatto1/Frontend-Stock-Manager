...
export const ProductCardSkeleton = () => {
   return (
    <tr>
     ...
     <td><p className="animate-pulse text-transparent bg-gray-500 dark:bg-gray-700">Loading...</p></td>
     <td className="hidden xl:table-cell"><p className="animate-pulse text-transparent bg-indigo-700">Loading...</p></td>
     <td className="hidden xl:table-cell"><p className="animate-pulse text-transparent bg-red-700">Loading...</p></td>
    </tr>
  )
}
