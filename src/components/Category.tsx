      ...
      <>
        <div className="hidden min-[523px]:flex relative min-w-48">
          ...
          <Transition show={open} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
            <ListboxOptions className="absolute z-20 top-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-gray-500 dark:bg-gray-800 py-1 text-base shadow-lg ring-1 ring-gray-200 ring-opacity-5 focus:outline-none sm:text-sm">
